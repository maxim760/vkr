...
var order_goods_entity_1 = require("../order/order-goods.entity");
...
var Goods = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToMany)(function () { return product_entity_1.Product; }, { onDelete: "CASCADE" }),
    ...
    __decorate([
        (0, typeorm_1.ManyToMany)(function () { return order_entity_1.Order; }, function (order) { return order.goods; }),
        __metadata("design:type", Array)
    ], Goods.prototype, "orders", void 0);
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return order_goods_entity_1.OrderGoods; }, function (orderGoods) { return orderGoods.goods; }),
        __metadata("design:type", Array)
