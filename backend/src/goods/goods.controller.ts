...
class GoodsController {
  ...
  async create(req: TypedRequestBody<OmitCreateEntity<Goods, "products"> & {products: string[]}>, res: Response, next: NextFunction) {
    try {
  ...
  async editProducts(req: TypedRequestBody<{ products: string[], id: string }>, res: Response, next: NextFunction) {
    try {
